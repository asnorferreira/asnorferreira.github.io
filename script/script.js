document.addEventListener("DOMContentLoaded", function () {
    ...
    const projectButtons = [
      { selector: ".manage-project .arrow-icon", href: "../portfolio-01-manage/index.html" },
      { selector: ".bookmark-project .arrow-icon", href: "../portfolio-02-bookmark/index.html" },
      { selector: ".insure-project .arrow-icon", href: "../portfolio-03-insure/index.html" },
      { selector: ".fylo-project .arrow-icon", href: "../portfolio-04-fylo/index.html" },
    ];
